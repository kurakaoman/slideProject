...
import java.util.Set;
    ...
    public class Icerink {
        ...
        @OneToMany(fetch = FetchType.EAGER, mappedBy = "icerink")//potem możesz to usunąć i zostawić tylko phoneNumber ten wyżej :-)))
...
//    private Customer fun;//List<Customer>;
        ...
        public Set<String> getPhoneNumber() { return phoneNumber; }

        public void setPhoneNumber(Set<String> phoneNumber) {this.phoneNumber = phoneNumber;}
        ...
        public Set<Additional> getAdditionals() {return additionals;}

        public void setAdditionals(Set<Additional> additionals) {this.additionals = additionals;}
